...
**[Sync/async](#async-и-sync-бок-о-бок)** ·
**[Пагинация](#пагинация)** ·
...
# sync — SyncClient, те же аргументы конструктора, блокирующие вызовы, event loop
# заводить не нужно
...
all_lots = await client.market.list_lots(filt).collect(limit=200)  # материализовать в список
