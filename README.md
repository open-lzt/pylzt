...
Каждый сгенерированный файл несёт `Generated by forge — DO NOT EDIT`: спека не всегда совпадает с тем, что API реально отдаёт, и реген затрёт правку руками. Что проверено вживую, что сломано и как патчить расхождение спека/реальность — [`docs/codegen-runbook.en.md`](docs/codegen-runbook.en.md) (на английском).
