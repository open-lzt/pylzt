...
from pylzt.methods.market_accounts_list import (
    ListDownload,
    ListFavorites,
    ListOrders,
    ListStates,
...
class GeneratedMarketFacade:
    """Generated by forge — DO NOT EDIT. Async facade for the market API."""
    ...
    async def managing_email_code(self, item_id: int) -> ItemCodeDataResponse:
    ...
    async def managing_steam_mafile_code(self, item_id: int) -> ItemCodeDataResponse:
    ...
    async def custom_discounts_get(self) -> CustomDiscountsGetResponse:
    ...
    async def managing_tags_list(self) -> list[Tag]:
