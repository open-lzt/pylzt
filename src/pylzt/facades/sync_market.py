...
class SyncGeneratedMarketFacade:
    ...
    def managing_bulk_action(self) -> ManagingBulkActionResponse:
        ...
        """
        return self._runner.run(self._async.managing_bulk_action())
    ...
    def purchasing_check(self, item_id: int) -> PurchasingCheckResponse:
        ...
        """
        return self._runner.run(self._async.purchasing_check(item_id=item_id))
    ...
    def purchasing_confirm(
        ...
        """
        return self._runner.run(
            self._async.purchasing_confirm(item_id=item_id, price=price, balance_id=balance_id)
        )

    def purchasing_discount_cancel(self, item_id: int) -> MarketStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.purchasing_discount_cancel(item_id=item_id))
    ...
    def purchasing_discount_request(
        ...
        """
        return self._runner.run(
            self._async.purchasing_discount_request(
                item_id=item_id,
    ...
    def purchasing_fast_buy(
        ...
        """
        return self._runner.run(
            self._async.purchasing_fast_buy(item_id=item_id, price=price, balance_id=balance_id)
        )
    ...
    def list_states(self, user_id: int | None = None) -> UserItemStates:
        ...
        """
        return self._runner.run(self._async.list_states(user_id=user_id))
    ...
    def managing_ai_price(self, item_id: int) -> int:
        ...
        """
        return self._runner.run(self._async.managing_ai_price(item_id=item_id))

    def managing_auto_bump(self, item_id: int, hour: int) -> MarketStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.managing_auto_bump(item_id=item_id, hour=hour))

    def managing_auto_bump_disable(self, item_id: int) -> MarketStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.managing_auto_bump_disable(item_id=item_id))

    def managing_auto_buy_price(self, item_id: int) -> int:
        ...
        """
        return self._runner.run(self._async.managing_auto_buy_price(item_id=item_id))
    ...
    def managing_bulk_get(
        ...
        """
        return self._runner.run(
            self._async.managing_bulk_get(item_id=item_id, parse_same_item_ids=parse_same_item_ids)
        )

    def managing_bump(self, item_id: int) -> MarketStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.managing_bump(item_id=item_id))
    ...
    def managing_change_password(
        ...
        """
        return self._runner.run(
            self._async.managing_change_password(item_id=item_id, cancel=cancel)
        )

    def managing_check_guarantee(self, item_id: int) -> str:
        ...
        """
        return self._runner.run(self._async.managing_check_guarantee(item_id=item_id))

    def managing_close(self, item_id: int) -> MarketStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.managing_close(item_id=item_id))

    def managing_create_claim(self, item_id: int, post_body: str) -> Thread:
        ...
        """
        return self._runner.run(
            self._async.managing_create_claim(item_id=item_id, post_body=post_body)
        )
    ...
    def managing_email_code(self, item_id: int) -> MarketItemCodeDataResponse:
        ...
        """
        return self._runner.run(self._async.managing_email_code(item_id=item_id))

    def managing_favorite(self, item_id: int) -> MarketStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.managing_favorite(item_id=item_id))
    ...
    def managing_get_letters(
        ...
        """
        return self._runner.run(self._async.managing_get_letters(item_id=item_id, limit=limit))
    ...
    def managing_image(self, item_id: int, type: Type) -> str:
        ...
        """
        return self._runner.run(self._async.managing_image(item_id=item_id, type=type))

    def managing_note_delete(self, item_id: int) -> MarketStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.managing_note_delete(item_id=item_id))
    ...
    def managing_note_edit(
        ...
        """
        return self._runner.run(self._async.managing_note_edit(item_id=item_id, text=text))

    def managing_open(self, item_id: int) -> MarketStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.managing_open(item_id=item_id))
    ...
    def managing_public_tag(
        ...
        """
        return self._runner.run(self._async.managing_public_tag(item_id=item_id, tag_id=tag_id))
    ...
    def managing_public_untag(
        ...
        """
        return self._runner.run(self._async.managing_public_untag(item_id=item_id, tag_id=tag_id))

    def managing_refuse_guarantee(self, item_id: int) -> MarketStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.managing_refuse_guarantee(item_id=item_id))

    def managing_steam_add_mafile(self, item_id: int) -> MarketStatusMessageItemResponse:
        ...
        """
        return self._runner.run(self._async.managing_steam_add_mafile(item_id=item_id))

    def managing_steam_get_mafile(self, item_id: int) -> MaFile:
        ...
        """
        return self._runner.run(self._async.managing_steam_get_mafile(item_id=item_id))

    def managing_steam_remove_mafile(self, item_id: int) -> MarketStatusMessageItemResponse:
        ...
        """
        return self._runner.run(self._async.managing_steam_remove_mafile(item_id=item_id))
    ...
    def managing_steam_mafile_code(self, item_id: int) -> MarketItemCodeDataResponse:
        ...
        """
        return self._runner.run(self._async.managing_steam_mafile_code(item_id=item_id))

    def managing_steam_preview(self, item_id: int, type: Type | None = None) -> str:
        ...
        """
        return self._runner.run(self._async.managing_steam_preview(item_id=item_id, type=type))
    ...
    def managing_steam_sda(
        ...
        """
        return self._runner.run(self._async.managing_steam_sda(item_id=item_id, id=id, nonce=nonce))
    ...
    def managing_steam_update_value(
        ...
        return self._runner.run(
            self._async.managing_steam_update_value(
                item_id=item_id, all=all, app_id=app_id, authorize=authorize
            )
        )
    ...
    def managing_stick(self, item_id: int) -> MarketStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.managing_stick(item_id=item_id))
    ...
    def managing_tag(
        ...
        """
        return self._runner.run(self._async.managing_tag(item_id=item_id, tag_id=tag_id))

    def managing_telegram_code(self, item_id: int) -> ManagingTelegramCodeResponse:
        ...
        """
        return self._runner.run(self._async.managing_telegram_code(item_id=item_id))

    def managing_telegram_reset_auth(self, item_id: int) -> MarketStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.managing_telegram_reset_auth(item_id=item_id))

    def managing_temp_email_password(self, item_id: int) -> ManagingTempEmailPasswordItem:
        ...
        """
        return self._runner.run(self._async.managing_temp_email_password(item_id=item_id))
    ...
    def managing_unfavorite(self, item_id: int) -> MarketStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.managing_unfavorite(item_id=item_id))

    def managing_unstick(self, item_id: int) -> MarketStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.managing_unstick(item_id=item_id))
    ...
    def managing_untag(
        ...
        """
        return self._runner.run(self._async.managing_untag(item_id=item_id, tag_id=tag_id))

    def manging_delete(self, item_id: int, reason: str) -> MarketStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.manging_delete(item_id=item_id, reason=reason))
    ...
    def profile_claims(
        ...
        """
        return self._runner.run(self._async.profile_claims(type=type, claim_state=claim_state))

    def cart_add(self, item_id: int) -> bool:
        ...
        """
        return self._runner.run(self._async.cart_add(item_id=item_id))

    def cart_delete(self, item_id: int | None = None) -> bool:
        ...
        """
        return self._runner.run(self._async.cart_delete(item_id=item_id))
    ...
    def category_wot_blitz(
        ...
        """
        return self._runner.run(
            self._async.category_wot_blitz(
                page=page,
                pmin=pmin,
                pmax=pmax,
                title=title,
    ...
    def custom_discounts_create(
        ...
        """
        return self._runner.run(
            self._async.custom_discounts_create(
                user_id=user_id,
                category_id=category_id,
    ...
    def custom_discounts_delete(self, discount_id: int) -> MarketStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.custom_discounts_delete(discount_id=discount_id))
    ...
    def custom_discounts_edit(
        ...
        """
        return self._runner.run(
            self._async.custom_discounts_edit(
    ...
    def custom_discounts_get(self) -> MarketDiscountsTotalResponse:
        ...
        """
        return self._runner.run(self._async.custom_discounts_get())
    ...
    def imap_create(
        ...
        """
        return self._runner.run(
            self._async.imap_create(
                domain=domain, imap_server=imap_server, port=port, secure=secure
            )
        )

    def imap_delete(self, domain: str) -> MarketStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.imap_delete(domain=domain))
    ...
    def payments_invoice_create(
        ...
        """
        return self._runner.run(
            self._async.payments_invoice_create(
                currency=currency,
                amount=amount,
    ...
    def payments_invoice_get(
        ...
        """
        return self._runner.run(
            self._async.payments_invoice_get(invoice_id=invoice_id, payment_id=payment_id)
        )
    ...
    def auto_payments_create(
        ...
        """
        return self._runner.run(
            self._async.auto_payments_create(
    ...
    def auto_payments_delete(self, auto_payment_id: int) -> MarketStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.auto_payments_delete(auto_payment_id=auto_payment_id))

    def auto_payments_list(self) -> dict[str, Any]:
        ...
        """
        return self._runner.run(self._async.auto_payments_list())
    ...
    def payments_balance_exchange(
        ...
        """
        return self._runner.run(
            self._async.payments_balance_exchange(
                from_balance=from_balance, to_balance=to_balance, amount=amount
            )
        )

    def payments_cancel(self, payment_id: int) -> MarketStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.payments_cancel(payment_id=payment_id))

    def payments_currency(self) -> PaymentsCurrencyResponse:
        ...
        """
        return self._runner.run(self._async.payments_currency())

    def payments_fee(self, currency: Currency, amount: float | None = None) -> PaymentsFeeResponse:
        ...
        """
        return self._runner.run(self._async.payments_fee(currency=currency, amount=amount))
    ...
    def payments_payout_services(self) -> list[System]:
        ...
        """
        return self._runner.run(self._async.payments_payout_services())
    ...
    def profile_get(self, fields_include: tuple[FieldsInclude, ...] | None = None) -> ToBalance:
        ...
        """
        return self._runner.run(self._async.profile_get(fields_include=fields_include))
    ...
    def proxy_delete(
        ...
        """
        return self._runner.run(self._async.proxy_delete(proxy_id=proxy_id, delete_all=delete_all))

    def proxy_get(self) -> list[Proxy]:
        ...
        """
        return self._runner.run(self._async.proxy_get())

    def managing_tags_create(
        ...
        """
        return self._runner.run(self._async.managing_tags_create(title=title, bc=bc))

    def managing_tags_delete(self, tag_id: int) -> MarketStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.managing_tags_delete(tag_id=tag_id))

    def managing_tags_edit(
        ...
        """
        return self._runner.run(self._async.managing_tags_edit(tag_id=tag_id, title=title, bc=bc))

    def managing_tags_list(self) -> list[MarketTagIdTitleIsDefaultForOwnedAccountsOnlyBcResponse]:
        ...
        """
        return self._runner.run(self._async.managing_tags_list())

    def managing_tags_order(self, tag_order: tuple[int, ...]) -> MarketStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.managing_tags_order(tag_order=tag_order))
