...
class SyncGeneratedForumFacade:
    """Generated by forge — DO NOT EDIT. Blocking facade for the forum API — each method runs `GeneratedForumFacade`'s async counterpart through a `SyncRunner`, no separate spec-derived implementation."""

    def __init__(self, async_facade: GeneratedForumFacade, runner: SyncRunner) -> None:
        self._async = async_facade
        self._runner = runner

    def assets_css(self, css: tuple[str, ...] | None = None) -> str:
        ...
        """
        return self._runner.run(self._async.assets_css(css=css))

    def o_auth_token(self) -> OAuthTokenResponse:
        ...
        """
        return self._runner.run(self._async.o_auth_token())

    def categories_get(self, category_id: int) -> str:
        ...
        """
        return self._runner.run(self._async.categories_get(category_id=category_id))
    ...
    def categories_list(
        ...
        return self._runner.run(
            self._async.categories_list(
                parent_category_id=parent_category_id, parent_forum_id=parent_forum_id, order=order
            )
        )

    def chatbox_delete_ignore(self, user_id: str) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.chatbox_delete_ignore(user_id=user_id))

    def chatbox_delete_message(self, message_id: int) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.chatbox_delete_message(message_id=message_id))

    def chatbox_edit_message(self, message_id: int, message: str) -> Message:
        ...
        """
        return self._runner.run(
            self._async.chatbox_edit_message(message_id=message_id, message=message)
        )

    def chatbox_get_ignore(self) -> list[Ignored]:
        ...
        """
        return self._runner.run(self._async.chatbox_get_ignore())

    def chatbox_get_leaderboard(self, duration: Duration | None = None) -> list[Leaderboard]:
        ...
        """
        return self._runner.run(self._async.chatbox_get_leaderboard(duration=duration))
    ...
    def chatbox_get_messages(
        ...
        """
        return self._runner.run(
            self._async.chatbox_get_messages(room_id=room_id, before_message_id=before_message_id)
        )

    def chatbox_index(self, room_id: int | None = None) -> ChatboxIndexResponse:
        ...
        """
        return self._runner.run(self._async.chatbox_index(room_id=room_id))

    def chatbox_online(self, room_id: int) -> list[MessageUser]:
        ...
        """
        return self._runner.run(self._async.chatbox_online(room_id=room_id))

    def chatbox_post_ignore(self, user_id: str) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.chatbox_post_ignore(user_id=user_id))
    ...
    def chatbox_post_message(
        ...
        """
        return self._runner.run(
            self._async.chatbox_post_message(
                room_id=room_id, message=message, reply_message_id=reply_message_id
            )
        )

    def chatbox_report(self, message_id: int, reason: str) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.chatbox_report(message_id=message_id, reason=reason))

    def chatbox_report_reasons(self, message_id: int) -> list[str]:
        ...
        """
        return self._runner.run(self._async.chatbox_report_reasons(message_id=message_id))

    def tags_find(self, tag: str) -> str:
        ...
        """
        return self._runner.run(self._async.tags_find(tag=tag))

    def tags_get(self, tag_id: int, page: int | None = None, limit: int | None = None) -> str:
        ...
        """
        return self._runner.run(self._async.tags_get(tag_id=tag_id, page=page, limit=limit))

    def tags_list(self, page: int | None = None, limit: int | None = None) -> str:
        ...
        """
        return self._runner.run(self._async.tags_list(page=page, limit=limit))

    def tags_popular(self) -> str:
        ...
        """
        return self._runner.run(self._async.tags_popular())

    def conversations_alerts_disable(self, conversation_id: int) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(
            self._async.conversations_alerts_disable(conversation_id=conversation_id)
        )

    def conversations_alerts_enable(self, conversation_id: int) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(
            self._async.conversations_alerts_enable(conversation_id=conversation_id)
        )
    ...
    def conversations_create(
        ...
        """
        return self._runner.run(
            self._async.conversations_create(
    ...
    def conversations_delete(
        ...
        """
        return self._runner.run(
            self._async.conversations_delete(
                conversation_id=conversation_id, delete_type=delete_type
            )
        )

    def conversations_get(self, conversation_id: int) -> str:
        ...
        """
        return self._runner.run(self._async.conversations_get(conversation_id=conversation_id))
    ...
    def conversations_invite(
        ...
        """
        return self._runner.run(
            self._async.conversations_invite(conversation_id=conversation_id, recipients=recipients)
        )

    def conversations_kick(self, conversation_id: int, user_id: int) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(
            self._async.conversations_kick(conversation_id=conversation_id, user_id=user_id)
        )
    ...
    def conversations_messages_create(
        ...
        """
        return self._runner.run(
            self._async.conversations_messages_create(
    ...
    def conversations_messages_delete(
        ...
        """
        return self._runner.run(
            self._async.conversations_messages_delete(
    ...
    def conversations_messages_edit(
        ...
        """
        return self._runner.run(
            self._async.conversations_messages_edit(
                conversation_id=conversation_id, message_id=message_id, message_body=message_body
            )
        )

    def conversations_messages_get(self, message_id: int) -> str:
        ...
        """
        return self._runner.run(self._async.conversations_messages_get(message_id=message_id))
    ...
    def conversations_messages_list(
        ...
        """
        return self._runner.run(
            self._async.conversations_messages_list(
                conversation_id=conversation_id,
                page=page,
                limit=limit,
                order=order,
    ...
    def conversations_messages_stick(
        ...
        """
        return self._runner.run(
            self._async.conversations_messages_stick(
                conversation_id=conversation_id, message_id=message_id
            )
        )
    ...
    def conversations_messages_unstick(
        ...
        """
        return self._runner.run(
            self._async.conversations_messages_unstick(
                conversation_id=conversation_id, message_id=message_id
            )
        )

    def conversations_read(self, conversation_id: int) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.conversations_read(conversation_id=conversation_id))

    def conversations_read_all(self) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.conversations_read_all())

    def conversations_save(self, link: str) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.conversations_save(link=link))
    ...
    def conversations_search(
        ...
        """
        return self._runner.run(
            self._async.conversations_search(
                q=q, conversation_id=conversation_id, search_recipients=search_recipients
            )
        )

    def conversations_share_content(self, thread_id: int) -> str:
        ...
        """
        return self._runner.run(self._async.conversations_share_content(thread_id=thread_id))

    def conversations_star(self, conversation_id: int) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.conversations_star(conversation_id=conversation_id))

    def conversations_start(self, user_id: str) -> Conversation:
        ...
        """
        return self._runner.run(self._async.conversations_start(user_id=user_id))

    def conversations_unstar(self, conversation_id: int) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.conversations_unstar(conversation_id=conversation_id))
    ...
    def conversations_update(
        ...
        """
        return self._runner.run(
            self._async.conversations_update(
                conversation_id=conversation_id,
                title=title,
                open_invite=open_invite,
    ...
    def forms_create(self) -> FormsCreateResponse:
        ...
        """
        return self._runner.run(self._async.forms_create())

    def forms_list(self, page: int | None = None) -> FormsListResponse:
        ...
        """
        return self._runner.run(self._async.forms_list(page=page))
    ...
    def forums_edit_feed_options(
        ...
        """
        return self._runner.run(
            self._async.forums_edit_feed_options(node_ids=node_ids, keywords=keywords)
        )
    ...
    def forums_followed(self, total: bool | None = None) -> str:
        ...
        """
        return self._runner.run(self._async.forums_followed(total=total))

    def forums_followers(self, forum_id: int) -> str:
        ...
        """
        return self._runner.run(self._async.forums_followers(forum_id=forum_id))

    def forums_get(self, forum_id: int) -> str:
        ...
        """
        return self._runner.run(self._async.forums_get(forum_id=forum_id))

    def forums_get_feed_options(self) -> ForumsGetFeedOptionsResponse:
        ...
        """
        return self._runner.run(self._async.forums_get_feed_options())

    def forums_grouped(self) -> ForumsGroupedResponse:
        ...
        """
        return self._runner.run(self._async.forums_grouped())
    ...
    def forums_list(
        ...
        """
        return self._runner.run(
            self._async.forums_list(
                parent_category_id=parent_category_id, parent_forum_id=parent_forum_id, order=order
            )
        )

    def forums_unfollow(self, forum_id: int) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.forums_unfollow(forum_id=forum_id))

    def links_get(self, link_id: int) -> LinkForum:
        ...
        """
        return self._runner.run(self._async.links_get(link_id=link_id))

    def links_list(self) -> LinksListResponse:
        ...
        """
        return self._runner.run(self._async.links_list())

    def notifications_get(self, notification_id: int) -> str:
        ...
        """
        return self._runner.run(self._async.notifications_get(notification_id=notification_id))

    def notifications_read(self, notification_id: int | None = None) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.notifications_read(notification_id=notification_id))

    def pages_get(self, page_id: int) -> str:
        ...
        """
        return self._runner.run(self._async.pages_get(page_id=page_id))
    ...
    def pages_list(
        ...
        """
        return self._runner.run(self._async.pages_list(parent_page_id=parent_page_id, order=order))

    def posts_comments_create(self, post_id: int, comment_body: str) -> str:
        ...
        """
        return self._runner.run(
            self._async.posts_comments_create(post_id=post_id, comment_body=comment_body)
        )
    ...
    def posts_comments_delete(
        ...
        """
        return self._runner.run(
            self._async.posts_comments_delete(post_comment_id=post_comment_id, reason=reason)
        )
    ...
    def posts_comments_edit(
        ...
        """
        return self._runner.run(
            self._async.posts_comments_edit(
    ...
    def posts_comments_get(
        ...
        """
        return self._runner.run(
            self._async.posts_comments_get(
                post_id=post_id,
                post_comment_id=post_comment_id,
                before=before,
    ...
    def posts_comments_report(
        ...
        """
        return self._runner.run(
            self._async.posts_comments_report(post_comment_id=post_comment_id, message=message)
        )

    def posts_comments_report_reasons(self, post_comment_id: int) -> list[str]:
        ...
        """
        return self._runner.run(
            self._async.posts_comments_report_reasons(post_comment_id=post_comment_id)
        )
    ...
    def posts_create(
        ...
        """
        return self._runner.run(
            self._async.posts_create(
                post_body=post_body, thread_id=thread_id, quote_post_id=quote_post_id
            )
        )

    def posts_delete(self, post_id: int, reason: str | None = None) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.posts_delete(post_id=post_id, reason=reason))
    ...
    def posts_edit(
        ...
        """
        return self._runner.run(
            self._async.posts_edit(
                post_id=post_id, post_body=post_body, message_state=message_state
            )
        )

    def posts_get(self, post_id: int) -> Post:
        ...
        """
        return self._runner.run(self._async.posts_get(post_id=post_id))

    def posts_like(self, post_id: int) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.posts_like(post_id=post_id))

    def posts_likes(self, post_id: int, page: int | None = None, limit: int | None = None) -> str:
        ...
        """
        return self._runner.run(self._async.posts_likes(post_id=post_id, page=page, limit=limit))
    ...
    def posts_report(self, post_id: int, message: str) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.posts_report(post_id=post_id, message=message))

    def posts_report_reasons(self, post_id: int) -> list[str]:
        ...
        """
        return self._runner.run(self._async.posts_report_reasons(post_id=post_id))

    def posts_unlike(self, post_id: int) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.posts_unlike(post_id=post_id))

    def profile_posts_comments_create(self, profile_post_id: int, comment_body: str) -> str:
        ...
        """
        return self._runner.run(
            self._async.profile_posts_comments_create(
                profile_post_id=profile_post_id, comment_body=comment_body
            )
        )

    def profile_posts_comments_delete(self, comment_id: int) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.profile_posts_comments_delete(comment_id=comment_id))
    ...
    def profile_posts_comments_edit(
        ...
        """
        return self._runner.run(
            self._async.profile_posts_comments_edit(
                comment_id=comment_id, comment_body=comment_body, message_state=message_state
            )
        )

    def profile_posts_comments_get(self, profile_post_id: int, comment_id: int) -> str:
        ...
        """
        return self._runner.run(
            self._async.profile_posts_comments_get(
                profile_post_id=profile_post_id, comment_id=comment_id
            )
        )
    ...
    def profile_posts_comments_list(
        ...
        """
        return self._runner.run(
            self._async.profile_posts_comments_list(
    ...
    def profile_posts_comments_report(
        ...
        """
        return self._runner.run(
            self._async.profile_posts_comments_report(message=message, comment_id=comment_id)
        )

    def profile_posts_comments_report_reasons(self, comment_id: int) -> list[str]:
        ...
        """
        return self._runner.run(
            self._async.profile_posts_comments_report_reasons(comment_id=comment_id)
        )

    def profile_posts_create(self, user_id: str, post_body: str) -> str:
        ...
        """
        return self._runner.run(
            self._async.profile_posts_create(user_id=user_id, post_body=post_body)
        )
    ...
    def profile_posts_delete(
        ...
        """
        return self._runner.run(
            self._async.profile_posts_delete(profile_post_id=profile_post_id, reason=reason)
        )
    ...
    def profile_posts_edit(
        ...
        """
        return self._runner.run(
            self._async.profile_posts_edit(
                profile_post_id=profile_post_id,
                post_body=post_body,
    ...
    def profile_posts_get(self, profile_post_id: int) -> str:
        ...
        """
        return self._runner.run(self._async.profile_posts_get(profile_post_id=profile_post_id))

    def profile_posts_like(self, profile_post_id: int) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.profile_posts_like(profile_post_id=profile_post_id))

    def profile_posts_likes(self, profile_post_id: int) -> str:
        ...
        """
        return self._runner.run(self._async.profile_posts_likes(profile_post_id=profile_post_id))
    ...
    def profile_posts_list(
        ...
        """
        return self._runner.run(
            self._async.profile_posts_list(
                user_id=user_id,
    ...
    def profile_posts_report(
        ...
        """
        return self._runner.run(
            self._async.profile_posts_report(profile_post_id=profile_post_id, message=message)
        )

    def profile_posts_report_reasons(self, profile_post_id: int) -> list[str]:
        ...
        """
        return self._runner.run(
            self._async.profile_posts_report_reasons(profile_post_id=profile_post_id)
        )

    def profile_posts_stick(self, profile_post_id: int) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.profile_posts_stick(profile_post_id=profile_post_id))

    def profile_posts_unlike(self, profile_post_id: int) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.profile_posts_unlike(profile_post_id=profile_post_id))

    def profile_posts_unstick(self, profile_post_id: int) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.profile_posts_unstick(profile_post_id=profile_post_id))
    ...
    def search_profile_posts(
        ...
        """
        return self._runner.run(
            self._async.search_profile_posts(
                q=q, user_id=user_id, page=page, limit=limit, before=before
            )
        )
    ...
    def search_results(
        ...
        """
        return self._runner.run(
            self._async.search_results(search_id=search_id, page=page, limit=limit)
        )
    ...
    def search_tagged(
        ...
        """
        return self._runner.run(
            self._async.search_tagged(tag=tag, tags=tags, page=page, limit=limit)
        )
    ...
    def search_users(self, q: str | None = None) -> list[User]:
        ...
        """
        return self._runner.run(self._async.search_users(q=q))

    def threads_bump(self, thread_id: int) -> str:
        ...
        """
        return self._runner.run(self._async.threads_bump(thread_id=thread_id))
    ...
    def threads_create_contest(
        ...
        """
        return self._runner.run(
            self._async.threads_create_contest(
                post_body=post_body,
    ...
    def threads_delete(
        ...
        """
        return self._runner.run(self._async.threads_delete(thread_id=thread_id, reason=reason))
    ...
    def threads_finish(self, thread_id: int) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.threads_finish(thread_id=thread_id))
    ...
    def threads_follow(
        ...
        """
        return self._runner.run(self._async.threads_follow(thread_id=thread_id, email=email))
    ...
    def threads_followed(
        ...
        """
        return self._runner.run(
            self._async.threads_followed(total=total, fields_include=fields_include)
        )

    def threads_followers(self, thread_id: int) -> str:
        ...
        """
        return self._runner.run(self._async.threads_followers(thread_id=thread_id))
    ...
    def threads_get(
        ...
        """
        return self._runner.run(
            self._async.threads_get(thread_id=thread_id, fields_include=fields_include)
        )

    def threads_hide(self, thread_id: int) -> str:
        ...
        """
        return self._runner.run(self._async.threads_hide(thread_id=thread_id))
    ...
    def threads_poll_get(self, thread_id: int) -> str:
        ...
        """
        return self._runner.run(self._async.threads_poll_get(thread_id=thread_id))
    ...
    def threads_recent(
        ...
        """
        return self._runner.run(
            self._async.threads_recent(
                days=days, limit=limit, forum_id=forum_id, data_limit=data_limit
            )
        )

    def threads_star(self, thread_id: int) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.threads_star(thread_id=thread_id))

    def threads_unfollow(self, thread_id: int) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.threads_unfollow(thread_id=thread_id))
    ...
    def threads_unread(
        ...
        """
        return self._runner.run(
            self._async.threads_unread(limit=limit, forum_id=forum_id, data_limit=data_limit)
        )

    def threads_unstar(self, thread_id: int) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.threads_unstar(thread_id=thread_id))

    def uptime_heartbeat(self) -> UptimeHeartbeatResponse:
        ...
        """
        return self._runner.run(self._async.uptime_heartbeat())

    def uptime_info(self) -> UptimeInfoResponse:
        ...
        """
        return self._runner.run(self._async.uptime_info())
    ...
    def users_avatar_crop(
        ...
        """
        return self._runner.run(self._async.users_avatar_crop(user_id=user_id, x=x, y=y, crop=crop))

    def users_avatar_delete(self, user_id: str) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.users_avatar_delete(user_id=user_id))
    ...
    def users_avatar_upload(
        ...
        """
        return self._runner.run(
            self._async.users_avatar_upload(user_id=user_id, avatar=avatar, x=x, y=y, crop=crop)
        )
    ...
    def users_background_crop(
        ...
        """
        return self._runner.run(
            self._async.users_background_crop(user_id=user_id, x=x, y=y, crop=crop)
        )

    def users_background_delete(self, user_id: str) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.users_background_delete(user_id=user_id))
    ...
    def users_background_upload(
        ...
        """
        return self._runner.run(
            self._async.users_background_upload(
                user_id=user_id, background=background, x=x, y=y, crop=crop
            )
        )
    ...
    def users_claims(
        ...
        """
        return self._runner.run(
            self._async.users_claims(user_id=user_id, type=type, claim_state=claim_state)
        )
    ...
    def users_contents(
        ...
        """
        return self._runner.run(self._async.users_contents(user_id=user_id, page=page, limit=limit))
    ...
    def users_fields(self) -> str:
        ...
        """
        return self._runner.run(self._async.users_fields())
    ...
    def users_find(
        ...
        """
        return self._runner.run(
            self._async.users_find(
                username=username, custom_fields=custom_fields, fields_include=fields_include
            )
        )

    def users_follow(self, user_id: str) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.users_follow(user_id=user_id))
    ...
    def users_followers(
        ...
        """
        return self._runner.run(
            self._async.users_followers(user_id=user_id, order=order, page=page, limit=limit)
        )
    ...
    def users_followings(
        ...
        """
        return self._runner.run(
            self._async.users_followings(user_id=user_id, order=order, page=page, limit=limit)
        )
    ...
    def users_get(
        ...
        """
        return self._runner.run(
            self._async.users_get(user_id=user_id, fields_include=fields_include)
        )

    def users_ignore(self, user_id: str) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.users_ignore(user_id=user_id))
    ...
    def users_ignored(self, total: bool | None = None) -> list[UsersIgnoredUser]:
        ...
        """
        return self._runner.run(self._async.users_ignored(total=total))
    ...
    def users_list(
        ...
        """
        return self._runner.run(
            self._async.users_list(page=page, limit=limit, fields_include=fields_include)
        )

    def users_sa_cancel_reset(self) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.users_sa_cancel_reset())

    def users_sa_reset(self) -> UsersSAResetResponse:
        ...
        """
        return self._runner.run(self._async.users_sa_reset())

    def users_secret_answer_types(self) -> list[UsersSecretAnswerTypesData]:
        ...
        """
        return self._runner.run(self._async.users_secret_answer_types())

    def users_trophies(self, user_id: str) -> UsersTrophiesResponse:
        ...
        """
        return self._runner.run(self._async.users_trophies(user_id=user_id))

    def users_unfollow(self, user_id: str) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.users_unfollow(user_id=user_id))

    def users_unignore(self, user_id: str) -> ForumStatusMessageResponse:
        ...
        """
        return self._runner.run(self._async.users_unignore(user_id=user_id))
