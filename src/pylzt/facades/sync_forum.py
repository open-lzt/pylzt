...
class SyncGeneratedForumFacade:
    ...
    def chatbox_online(self, room_id: int) -> list[User]:
    ...
    def conversations_start(self, user_id: str) -> ConversationsMessagesEditMessage:
    ...
    def search_users(self, q: str | None = None) -> list[SearchAllUser]:
    ...
    def threads_navigation(self, thread_id: int) -> str:
        ...
        """
        return self._runner.run(self._async.threads_navigation(thread_id=thread_id))
