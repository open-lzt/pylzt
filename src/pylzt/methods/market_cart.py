...
# Source: official OpenAPI spec, operationId "Cart.Add".
class CartAdd(BaseMethod[bool]):
...
# Source: official OpenAPI spec, operationId "Cart.Delete".
class CartDelete(BaseMethod[bool]):
