...
from pylzt.enums.forum import DeleteType, Order
...
# Source: official OpenAPI spec, operationId "Conversations.Alerts.Disable".
class ConversationsAlertsDisable(BaseMethod[ForumStatusMessageResponse]):
...
# Source: official OpenAPI spec, operationId "Conversations.Create".
class ConversationsCreate(BaseMethod[Conversation]):
...
# Source: official OpenAPI spec, operationId "Conversations.Delete".
class ConversationsDelete(BaseMethod[ForumStatusMessageResponse]):
...
# Source: official OpenAPI spec, operationId "Conversations.Messages.Create".
class ConversationsMessagesCreate(BaseMethod[ConversationsMessagesCreateMessage]):
    ...
    __returning__ = ConversationsMessagesCreateMessage
    __unwrap__ = "message"
...
# Source: official OpenAPI spec, operationId "Conversations.Messages.Delete".
class ConversationsMessagesDelete(BaseMethod[ForumStatusMessageResponse]):
...
class ConversationsMessagesEdit(BaseMethod[Conversation]):
...
# Source: official OpenAPI spec, operationId "Conversations.Messages.Stick".
class ConversationsMessagesStick(BaseMethod[ForumStatusMessageResponse]):
...
# Source: official OpenAPI spec, operationId "Conversations.Star".
class ConversationsStar(BaseMethod[ForumStatusMessageResponse]):
...
class ConversationsStart(BaseMethod[Conversation]):
