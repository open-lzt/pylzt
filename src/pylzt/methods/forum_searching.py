...
from pylzt.models.forum import DataDataTotalLinksResponse, SearchAllResponse, SearchAllUser
...
class SearchPosts(BaseMethod[DataDataTotalLinksResponse]):
    ...
    __returning__ = DataDataTotalLinksResponse
...
class SearchProfilePosts(BaseMethod[DataDataTotalLinksResponse]):
...
class SearchTagged(BaseMethod[DataDataTotalLinksResponse]):
...
class SearchThreads(BaseMethod[DataDataTotalLinksResponse]):
