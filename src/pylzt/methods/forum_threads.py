...
# Source: official OpenAPI spec, operationId "Threads.Create".
class ThreadsCreate(BaseMethod[Content]):
...
# Source: official OpenAPI spec, operationId "Threads.Delete".
class ThreadsDelete(BaseMethod[ForumStatusMessageResponse]):
...
# Source: official OpenAPI spec, operationId "Threads.Edit".
class ThreadsEdit(BaseMethod[Content]):
...
# Source: official OpenAPI spec, operationId "Threads.Follow".
class ThreadsFollow(BaseMethod[ForumStatusMessageResponse]):
...
# Source: official OpenAPI spec, operationId "Threads.Followers".
class ThreadsFollowers(BaseMethod[str]):
...
# Source: official OpenAPI spec, operationId "Threads.Star".
class ThreadsStar(BaseMethod[ForumStatusMessageResponse]):
