...
from pylzt.enums.forum import FieldsInclude, MessageState
...
# Source: official OpenAPI spec, operationId "ProfilePosts.Delete".
class ProfilePostsDelete(BaseMethod[ForumStatusMessageResponse]):
...
# Source: official OpenAPI spec, operationId "ProfilePosts.Edit".
class ProfilePostsEdit(BaseMethod[str]):
...
# Source: official OpenAPI spec, operationId "ProfilePosts.Like".
class ProfilePostsLike(BaseMethod[ForumStatusMessageResponse]):
...
# Source: official OpenAPI spec, operationId "ProfilePosts.Likes".
class ProfilePostsLikes(BaseMethod[str]):
...
# Source: official OpenAPI spec, operationId "ProfilePosts.Report".
class ProfilePostsReport(BaseMethod[ForumStatusMessageResponse]):
...
# Source: official OpenAPI spec, operationId "ProfilePosts.Stick".
class ProfilePostsStick(BaseMethod[ForumStatusMessageResponse]):
